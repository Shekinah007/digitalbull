...
export const Courses = () => {
  return (
    <div
      id="course-outline"
      className={`min-h-screen flex flex-col items-center overflow-x-hidden justify-center text-gray-200 gap-2 py-16 bg-gray-600 `}
    >
      <div className="flex justify-between w-full">
        <h2 className="text-2xl md:text-3xl font-bold md:self-start ml-[30px] md:ml-[120px] ">
          Course Outline
        </h2>
      </div>
      ...
      <div className="flex flex-col md:flex-row md:gap-10 text-sm font-semibold">
        <div className="flex flex-col gap-5 rounded-2xl box-shadow p-3 px-7 md:p-8 md:w-[540px] md:border border-gray-400 left">
          <div className="flex gap-7 md:gap-10 items-center">
            <span className="h-7 w-7 rounded-full bg-red-500 text-white flex items-center justify-center">
              1
            </span>
            <ul>
