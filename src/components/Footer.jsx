    ...
    <footer className="bg-black  py-10 text-gray-300 flex flex-col md:flex-row gap-10 justify-around items-center">
      <div className="flex flex-col md:flex-row  items-center gap-2 text-sm">
        <div className="max-w-[80vw] md:w-[400px] flex flex-col gap-5 text-center md:text-left">
          <p>
            If you are interested in one of our packages and obtaining your own
            copy of the stock price visualization tool.
        ...
        <div className="hidden md:flex self-end md:self-start mt-[5px] gap-3 items-center ">
          ...
          <a
            href="mailto:info@digitbull.com"
            className="p-2 rounded-md text-white send-email"
          >
            Send us an email
          </a>
        </div>
      ...
      <div className="flex flex-col items-center">
        ...
        <p className="text-xs text-gray-500">info@digitbull.com</p>
      </div>
    </footer>
  );
};
