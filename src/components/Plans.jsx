            ...
            <div className="flex flex-wrap items-center justify-center gap-10">
                ...
                <div className={`card flex flex-col justify-start gap-5 animate`}>
                    ...
                    <div className="h-full text-sm flex flex-col gap-2 justify-around self-center items-start">
                        ...
                        <button className="cursor-pointer bg-green-500 text-lg p-1 w-[150px] rounded-2xl self-center font-bold text-white">250<span className="text-red-500 text-sm">USD</span></button>
                    </div>
                </div>
                ...
                <div className="card flex flex-col justify-start gap-5 animate">
                    ...
                    <div className="h-full text-sm flex flex-col gap-2 justify-around self-center items-start">
                        ...
                        <button className="shadow bg-green-500 text-lg p-1 w-[150px] rounded-2xl self-center font-bold text-white">400<span className="text-red-500 text-sm ">USD</span></button>
                    </div>
                </div>
