...
export const Plans = () => {
    return (
        <div id="plans" className="min-h-screen flex flex-col items-center justify-center gap-5 bg-white py-10 text-gray-500">
            <h2 className="text-3xl font-bold"><span className="text-red-400">Flexible</span> Plans</h2>
            <p className="text-lg font-semibold">Choose a plan that works best for you</p>
            <div className="flex flex-wrap items-center justify-center gap-10">
                <div className="card flex flex-col justify-start gap-5">
                    <div className="bg-red-400 h-[140px] w-full flex flex-col gap-1 justify-center
